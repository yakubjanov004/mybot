...
--
-- Name: cleanup_expired_cache(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: get_application_stats(integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_application_stats(days_back integer DEFAULT 30, source_filter text DEFAULT 'all'::text) RETURNS TABLE(total_applications bigint, client_created bigint, staff_created bigint, staff_percentage numeric, success_rate numeric, error_rate numeric, avg_per_day numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_application_stats(days_back integer, source_filter text) OWNER TO postgres;

--
-- Name: update_inbox_messages_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_inbox_messages_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.update_inbox_messages_updated_at() OWNER TO postgres;
...
CREATE TABLE public.alert_rules (
    ...
    CONSTRAINT alert_rules_frequency_check CHECK (((frequency)::text = ANY ((ARRAY['real_time'::character varying, 'hourly'::character varying, 'daily'::character varying, 'weekly'::character varying])::text[])))
);
...
COMMENT ON TABLE public.alert_rules IS 'Configuration for automated alert rules';
...
CREATE TABLE public.application_alerts (
    ...
    CONSTRAINT application_alerts_severity_check CHECK (((severity)::text = ANY ((ARRAY['info'::character varying, 'warning'::character varying, 'critical'::character varying])::text[])))
);
...
--
-- Name: TABLE application_alerts; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.application_alerts IS 'System alerts for unusual application creation patterns';
...
CREATE SEQUENCE public.application_alerts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.application_alerts_id_seq OWNER TO postgres;

--
-- Name: application_alerts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.application_alerts_id_seq OWNED BY public.application_alerts.id;


--
-- Name: application_statistics_cache; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.application_statistics_cache (
    id integer NOT NULL,
    cache_key character varying(255) NOT NULL,
    period_days integer NOT NULL,
    source_filter character varying(50),
    role_filter character varying(50),
...
ALTER TABLE public.application_statistics_cache OWNER TO postgres;

--
-- Name: TABLE application_statistics_cache; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.application_statistics_cache IS 'Performance cache for application statistics';


--
-- Name: application_statistics_cache_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.application_statistics_cache_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.application_statistics_cache_id_seq OWNER TO postgres;

--
-- Name: application_statistics_cache_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.application_statistics_cache_id_seq OWNED BY public.application_statistics_cache.id;


--
-- Name: application_tracking_reports; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.application_tracking_reports (
    id integer NOT NULL,
...
ALTER TABLE public.application_tracking_reports OWNER TO postgres;

--
-- Name: TABLE application_tracking_reports; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.application_tracking_reports IS 'Generated tracking and reporting data';


--
-- Name: application_tracking_reports_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.application_tracking_reports_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.application_tracking_reports_id_seq OWNER TO postgres;

--
-- Name: application_tracking_reports_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.application_tracking_reports_id_seq OWNED BY public.application_tracking_reports.id;
...
--
-- Name: COLUMN service_requests.role_current; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.service_requests.role_current IS 'Current role assigned to handle this service request for inbox system';
...
--
-- Name: application_tracking_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.application_tracking_summary AS
 SELECT date(created_at) AS date,
    count(*) AS total_applications,
    count(
        CASE
            WHEN (created_by_staff = true) THEN 1
            ELSE NULL::integer
        END) AS staff_created,
    count(
        CASE
            WHEN (created_by_staff = false) THEN 1
            ELSE NULL::integer
        END) AS client_created,
    round((((count(
        CASE
            WHEN (created_by_staff = true) THEN 1
            ELSE NULL::integer
        END))::numeric * 100.0) / (count(*))::numeric), 2) AS staff_percentage,
    count(
        CASE
            WHEN ((current_status)::text = 'completed'::text) THEN 1
            ELSE NULL::integer
        END) AS completed_applications,
    round((((count(
        CASE
            WHEN ((current_status)::text = 'completed'::text) THEN 1
            ELSE NULL::integer
...
ALTER VIEW public.application_tracking_summary OWNER TO postgres;

--
-- Name: VIEW application_tracking_summary; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON VIEW public.application_tracking_summary IS 'Daily summary of application creation statistics';


--
-- Name: application_transfers; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.application_transfers (
    id integer NOT NULL,
    ...
    transfer_notes text,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT application_transfers_application_type_check CHECK (((application_type)::text = ANY ((ARRAY['zayavka'::character varying, 'service_request'::character varying])::text[]))),
    CONSTRAINT application_transfers_from_role_check CHECK (((from_role)::text = ANY ((ARRAY['manager'::character varying, 'junior_manager'::character varying, 'technician'::character varying, 'warehouse'::character varying, 'call_center'::character varying, 'call_center_supervisor'::character varying, 'controller'::character varying])::text[]))),
    CONSTRAINT application_transfers_to_role_check CHECK (((to_role)::text = ANY ((ARRAY['manager'::character varying, 'junior_manager'::character varying, 'technician'::character varying, 'warehouse'::character varying, 'call_center'::character varying, 'call_center_supervisor'::character varying, 'controller'::character varying])::text[]))),
    CONSTRAINT check_transfer_application_exists CHECK (((((application_type)::text = 'zayavka'::text) AND ((application_id)::text ~ '^[0-9]+$'::text)) OR (((application_type)::text = 'service_request'::text) AND ((application_id)::text ~ '^[a-f0-9-]{36}$'::text))))
);


ALTER TABLE public.application_transfers OWNER TO postgres;

--
-- Name: TABLE application_transfers; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.application_transfers IS 'Audit trail for application transfers between roles';


--
-- Name: COLUMN application_transfers.application_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.application_transfers.application_id IS 'ID of the transferred application';


--
-- Name: COLUMN application_transfers.application_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.application_transfers.application_type IS 'Type of application: zayavka or service_request';


--
-- Name: COLUMN application_transfers.from_role; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.application_transfers.from_role IS 'Role that transferred the application (NULL for initial assignment)';


--
-- Name: COLUMN application_transfers.to_role; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.application_transfers.to_role IS 'Role that received the application';


--
-- Name: COLUMN application_transfers.transferred_by; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.application_transfers.transferred_by IS 'User who performed the transfer';


--
-- Name: application_transfers_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.application_transfers_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.application_transfers_id_seq OWNER TO postgres;

--
-- Name: application_transfers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.application_transfers_id_seq OWNED BY public.application_transfers.id;
...
COMMENT ON TABLE public.client_selection_data IS 'Client selection data during staff application creation';
...
COMMENT ON TABLE public.staff_application_audit IS 'Audit trail for staff-created applications';
...
CREATE TABLE public.inbox_messages (
    ...
    message_type character varying(50) DEFAULT 'application'::character varying,
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT check_application_exists CHECK (((((application_type)::text = 'zayavka'::text) AND ((application_id)::text ~ '^[0-9]+$'::text)) OR (((application_type)::text = 'service_request'::text) AND ((application_id)::text ~ '^[a-f0-9-]{36}$'::text)))),
    CONSTRAINT inbox_messages_application_type_check CHECK (((application_type)::text = ANY ((ARRAY['zayavka'::character varying, 'service_request'::character varying])::text[]))),
    CONSTRAINT inbox_messages_assigned_role_check CHECK (((assigned_role)::text = ANY ((ARRAY['manager'::character varying, 'junior_manager'::character varying, 'technician'::character varying, 'warehouse'::character varying, 'call_center'::character varying, 'call_center_supervisor'::character varying, 'controller'::character varying])::text[]))),
    CONSTRAINT inbox_messages_message_type_check CHECK (((message_type)::text = ANY ((ARRAY['application'::character varying, 'transfer'::character varying, 'notification'::character varying, 'reminder'::character varying])::text[]))),
    CONSTRAINT inbox_messages_priority_check CHECK (((priority)::text = ANY ((ARRAY['low'::character varying, 'medium'::character varying, 'high'::character varying, 'urgent'::character varying])::text[])))
);
...
--
-- Name: TABLE inbox_messages; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.inbox_messages IS 'Messages and notifications for role-based inbox system';


--
-- Name: COLUMN inbox_messages.application_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.inbox_messages.application_id IS 'ID of the application (zayavka.id or service_requests.id)';


--
-- Name: COLUMN inbox_messages.application_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.inbox_messages.application_type IS 'Type of application: zayavka or service_request';


--
-- Name: COLUMN inbox_messages.assigned_role; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.inbox_messages.assigned_role IS 'Role that should see this message in their inbox';


--
-- Name: COLUMN inbox_messages.message_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.inbox_messages.message_type IS 'Type of message: application, transfer, notification, reminder';


--
-- Name: COLUMN inbox_messages.is_read; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.inbox_messages.is_read IS 'Whether the message has been read by the assigned role';
...
--
-- Name: recent_alerts_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.recent_alerts_summary AS
 SELECT alert_type,
    severity,
    ...
    count(
        CASE
            WHEN (acknowledged = false) THEN 1
            ELSE NULL::integer
        END) AS unacknowledged_count
   FROM public.application_alerts
  WHERE (created_at >= (CURRENT_DATE - '7 days'::interval))
  GROUP BY alert_type, severity
  ORDER BY (count(*)) DESC, (max(created_at)) DESC;


ALTER VIEW public.recent_alerts_summary OWNER TO postgres;

--
-- Name: VIEW recent_alerts_summary; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON VIEW public.recent_alerts_summary IS 'Summary of recent system alerts';
...
--
-- Name: role_performance_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.role_performance_summary AS
 SELECT staff_creator_role AS role,
    count(*) AS total_applications,
    count(
        CASE
            WHEN ((current_status)::text = 'completed'::text) THEN 1
    ...
    count(
        CASE
            WHEN ((current_status)::text = ANY ((ARRAY['cancelled'::character varying, 'failed'::character varying])::text[])) THEN 1
            ELSE NULL::integer
        END) AS failed_applications,
    round((((count(
        CASE
            WHEN ((current_status)::text = ANY ((ARRAY['cancelled'::character varying, 'failed'::character varying])::text[])) THEN 1
            ELSE NULL::integer
        END))::numeric * 100.0) / (count(*))::numeric), 2) AS error_rate,
    round(((count(*))::numeric / EXTRACT(days FROM ((max(created_at) - min(created_at)) + '1 day'::interval))), 2) AS avg_per_day
   FROM public.service_requests
  WHERE ((created_by_staff = true) AND (staff_creator_role IS NOT NULL) AND (created_at >= (CURRENT_DATE - '30 days'::interval)))
  GROUP BY staff_creator_role
  ORDER BY (count(*)) DESC;


ALTER VIEW public.role_performance_summary OWNER TO postgres;

--
-- Name: VIEW role_performance_summary; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON VIEW public.role_performance_summary IS 'Performance summary by staff role';
...
CREATE TABLE public.zayavki (
    ...
    CONSTRAINT zayavki_assigned_role_check CHECK (((assigned_role)::text = ANY ((ARRAY['manager'::character varying, 'junior_manager'::character varying, 'technician'::character varying, 'warehouse'::character varying, 'call_center'::character varying, 'call_center_supervisor'::character varying, 'controller'::character varying])::text[]))),
...
--
-- Name: COLUMN zayavki.assigned_role; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.zayavki.assigned_role IS 'Current role assigned to handle this zayavka for inbox system';
...
--
-- Name: application_alerts id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_alerts ALTER COLUMN id SET DEFAULT nextval('public.application_alerts_id_seq'::regclass);


--
-- Name: application_statistics_cache id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_statistics_cache ALTER COLUMN id SET DEFAULT nextval('public.application_statistics_cache_id_seq'::regclass);


--
-- Name: application_tracking_reports id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_tracking_reports ALTER COLUMN id SET DEFAULT nextval('public.application_tracking_reports_id_seq'::regclass);


--
-- Name: application_transfers id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_transfers ALTER COLUMN id SET DEFAULT nextval('public.application_transfers_id_seq'::regclass);
...
8	5955605892	user_activity_message	text:/start...	t	User manager activity logged	2025-07-18 16:49:49.767044+05	\N	\N	\N
9	5955605892	user_activity_message	text:🔌 Ulanish uchun ariza...	t	User manager activity logged	2025-07-18 16:49:54.243638+05	\N	\N	\N
\.
...
COPY public.alert_rules (id, rule_id, name, description, alert_type, threshold_config, frequency, channels, recipients, is_active, created_at, updated_at, last_triggered, trigger_count) FROM stdin;
1	high_staff_creation_rate	High Staff Creation Rate	Alert when staff creation rate exceeds normal levels	high_staff_creation_rate	{"baseline_comparison": true, "minimum_applications": 10, "staff_percentage_threshold": 70}	hourly	["telegram", "database"]	[]	t	2025-07-18 10:41:17.856265+05	2025-07-18 10:41:17.856265+05	\N	0
2	low_client_creation_rate	Low Client Self-Service Rate	Alert when client self-service rate drops significantly	low_client_creation_rate	{"drop_percentage": 20, "baseline_comparison": true, "client_percentage_threshold": 30}	hourly	["telegram", "database"]	[]	t	2025-07-18 10:41:17.856265+05	2025-07-18 10:41:17.856265+05	\N	0
3	success_rate_drop	Success Rate Drop	Alert when application success rate drops below acceptable levels	success_rate_drop	{"drop_percentage": 15, "baseline_comparison": true, "success_rate_threshold": 80}	hourly	["telegram", "database"]	[]	t	2025-07-18 10:41:17.856265+05	2025-07-18 10:41:17.856265+05	\N	0
4	error_spike	Error Rate Spike	Alert when error rate spikes above normal levels	error_spike	{"spike_percentage": 5, "baseline_comparison": true, "error_rate_threshold": 10}	hourly	["telegram", "database"]	[]	t	2025-07-18 10:41:17.856265+05	2025-07-18 10:41:17.856265+05	\N	0
5	unusual_role_activity	Unusual Role Activity	Alert when specific roles show unusual activity patterns	unusual_role_activity	{"minimum_baseline": 1, "roles_to_monitor": ["manager", "junior_manager", "controller", "call_center"], "activity_multiplier": 3}	daily	["telegram", "database"]	[]	t	2025-07-18 10:41:17.856265+05	2025-07-18 10:41:17.856265+05	\N	0
\.
...
COPY public.application_alerts (id, alert_id, rule_id, alert_type, severity, title, message, data, channels, recipients, created_at, sent_at, delivery_status, acknowledged, acknowledged_by, acknowledged_at) FROM stdin;
\.


--
-- Data for Name: application_statistics_cache; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.application_statistics_cache (id, cache_key, period_days, source_filter, role_filter, statistics_data, created_at, expires_at) FROM stdin;
\.


--
-- Data for Name: application_tracking_reports; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.application_tracking_reports (id, report_id, report_type, period, format_type, generated_by, report_data, summary_data, file_path, created_at, expires_at) FROM stdin;
\.


--
-- Data for Name: application_transfers; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.application_transfers (id, application_id, application_type, from_role, to_role, transferred_by, transfer_reason, transfer_notes, created_at) FROM stdin;
\.
...
COPY public.inbox_messages (id, application_id, application_type, assigned_role, message_type, title, description, priority, is_read, created_at, updated_at) FROM stdin;
\.
...
COPY public.zayavki (id, public_id, zayavka_type, user_id, description, status, role_current, current_user_id, address, latitude, longitude, abonent_id, phone_number, priority, created_by, created_by_role, assigned_at, completed_at, closed_at, created_at, updated_at, assigned_to, assigned_role) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.access_control_logs_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.alert_rules_id_seq', 5, true);
...
--
-- Name: application_statistics_cache_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.application_statistics_cache_id_seq', 1, false);


--
-- Name: application_tracking_reports_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.application_tracking_reports_id_seq', 1, false);


--
-- Name: application_transfers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.application_transfers_id_seq', 1, false);
...
--
-- Name: alert_rules alert_rules_rule_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.alert_rules
    ADD CONSTRAINT alert_rules_rule_id_key UNIQUE (rule_id);


--
-- Name: application_alerts application_alerts_alert_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_alerts
    ADD CONSTRAINT application_alerts_alert_id_key UNIQUE (alert_id);
...
--
-- Name: application_statistics_cache application_statistics_cache_cache_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_statistics_cache
    ADD CONSTRAINT application_statistics_cache_cache_key_key UNIQUE (cache_key);


--
-- Name: application_statistics_cache application_statistics_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_statistics_cache
    ADD CONSTRAINT application_statistics_cache_pkey PRIMARY KEY (id);


--
-- Name: application_tracking_reports application_tracking_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_tracking_reports
    ADD CONSTRAINT application_tracking_reports_pkey PRIMARY KEY (id);


--
-- Name: application_tracking_reports application_tracking_reports_report_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_tracking_reports
    ADD CONSTRAINT application_tracking_reports_report_id_key UNIQUE (report_id);


--
-- Name: application_transfers application_transfers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_transfers
    ADD CONSTRAINT application_transfers_pkey PRIMARY KEY (id);
...
--
-- Name: idx_alert_rules_alert_type; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alert_rules_alert_type ON public.alert_rules USING btree (alert_type);


--
-- Name: idx_alert_rules_frequency; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alert_rules_frequency ON public.alert_rules USING btree (frequency);


--
-- Name: idx_alert_rules_is_active; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alert_rules_is_active ON public.alert_rules USING btree (is_active);


--
-- Name: idx_alert_rules_rule_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alert_rules_rule_id ON public.alert_rules USING btree (rule_id);
...
CREATE INDEX idx_alerts_acknowledged ON public.application_alerts USING btree (acknowledged);


--
-- Name: idx_alerts_alert_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alerts_alert_id ON public.application_alerts USING btree (alert_id);
...
CREATE INDEX idx_alerts_alert_type ON public.application_alerts USING btree (alert_type);
...
CREATE INDEX idx_alerts_created_at ON public.application_alerts USING btree (created_at);


--
-- Name: idx_alerts_rule_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_alerts_rule_id ON public.application_alerts USING btree (rule_id);
...
CREATE INDEX idx_alerts_severity ON public.application_alerts USING btree (severity);


--
-- Name: idx_application_transfers_application; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_application_transfers_application ON public.application_transfers USING btree (application_id, application_type);


--
-- Name: idx_application_transfers_created_desc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_application_transfers_created_desc ON public.application_transfers USING btree (created_at DESC);


--
-- Name: idx_application_transfers_from_role; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_application_transfers_from_role ON public.application_transfers USING btree (from_role, created_at DESC);


--
-- Name: idx_application_transfers_to_role; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_application_transfers_to_role ON public.application_transfers USING btree (to_role, created_at DESC);


--
-- Name: idx_application_transfers_transferred_by; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_application_transfers_transferred_by ON public.application_transfers USING btree (transferred_by, created_at DESC);
...
--
-- Name: idx_inbox_messages_application; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_inbox_messages_application ON public.inbox_messages USING btree (application_id, application_type);


--
-- Name: idx_inbox_messages_created_desc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_inbox_messages_created_desc ON public.inbox_messages USING btree (created_at DESC);


--
-- Name: idx_inbox_messages_priority; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_inbox_messages_priority ON public.inbox_messages USING btree (priority, created_at DESC);


--
-- Name: idx_inbox_messages_role_read; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_inbox_messages_role_read ON public.inbox_messages USING btree (assigned_role, is_read);
...
CREATE INDEX idx_reports_created_at ON public.application_tracking_reports USING btree (created_at);
...
CREATE INDEX idx_reports_generated_by ON public.application_tracking_reports USING btree (generated_by);


--
-- Name: idx_reports_report_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_reports_report_id ON public.application_tracking_reports USING btree (report_id);
...
CREATE INDEX idx_reports_type ON public.application_tracking_reports USING btree (report_type);
...
--
-- Name: idx_service_requests_creator_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_service_requests_creator_date ON public.service_requests USING btree (staff_creator_id, created_at) WHERE (staff_creator_id IS NOT NULL);
...
--
-- Name: idx_service_requests_source_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_service_requests_source_date ON public.service_requests USING btree (creation_source, created_at);
...
--
-- Name: idx_service_requests_staff_creator_role; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_service_requests_staff_creator_role ON public.service_requests USING btree (staff_creator_role);


--
-- Name: idx_service_requests_staff_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_service_requests_staff_date ON public.service_requests USING btree (created_by_staff, created_at);
...
--
-- Name: idx_staff_audit_creator_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_staff_audit_creator_date ON public.staff_application_audit USING btree (creator_id, creation_timestamp);
...
--
-- Name: idx_staff_audit_role_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_staff_audit_role_date ON public.staff_application_audit USING btree (creator_role, creation_timestamp);
...
--
-- Name: idx_staff_audit_success_status; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_staff_audit_success_status ON public.staff_application_audit USING btree (client_notified, workflow_initiated);
...
--
-- Name: idx_stats_cache_expires; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_stats_cache_expires ON public.application_statistics_cache USING btree (expires_at);


--
-- Name: idx_stats_cache_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_stats_cache_key ON public.application_statistics_cache USING btree (cache_key);
...
--
-- Name: idx_zayavki_assigned_role; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_zayavki_assigned_role ON public.zayavki USING btree (assigned_role) WHERE (assigned_role IS NOT NULL);
...
--
-- Name: inbox_messages trigger_inbox_messages_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_inbox_messages_updated_at BEFORE UPDATE ON public.inbox_messages FOR EACH ROW EXECUTE FUNCTION public.update_inbox_messages_updated_at();
...
--
-- Name: application_transfers application_transfers_transferred_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.application_transfers
    ADD CONSTRAINT application_transfers_transferred_by_fkey FOREIGN KEY (transferred_by) REFERENCES public.users(id);
...
ALTER TABLE ONLY public.access_control_logs
    ADD CONSTRAINT fk_access_logs_user_id FOREIGN KEY (user_id) REFERENCES public.users(telegram_id);
